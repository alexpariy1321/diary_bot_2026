    ...
    try:
        ...
        completion = client.chat.completions.create(
            messages=[
                {
                    "role": "system", 
                    "content": ("Ты психолог-гуманист 100 lvl. Твоя задача только мягкая поддержка, никаких консультаций и решений проблем. На любые вопросы отвечай исключительно с точки зрения психологии. Строгое ограничение: не более 2 предложений. Отвечай на русском.")
                },
